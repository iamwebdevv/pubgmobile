                ...
                <div class="banner-wrap">
                    <div id="swiper" class="swiper-container" style="height: auto;overflow: visible;">
                        <div class="swiper-wrapper swiper-wrapper1" id="swiper-wrapper">
                            <div class="swiper-slide" style="background: url(img/myBanner.png) no-repeat center;background-size: cover;"></div>
                        </div>
                    </div>
                    <div class="mc"></div>
                    <div class="nav-box">
                        <div data-tab="tab-list" class="main">
                            <ul>
                                ...
                                <li class="list tab-count active"><a class="go-currency-btn">Redeem</a></li>
                                <li class="list tab-count"><a class="go-redeem-btn">Purchase</a></li>
                        ...
                        <div class="t">
                            <div class="p-box g-clr">
                                <div class="box">
                                    ...
                                    <p class="p">Please send email to <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="58303d34281835313c392b3a2d21763b3735">[email&#160;protected]</a></p>
                                </div>
